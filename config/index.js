  ...
  [
    'tarojs-router-next-plugin',
    {
      packages: [
        ...
        // },
        { name: 'featureB', pagePath: path.resolve(__dirname, '../src/featureB/pages') },
      ],
    },
  ],
];
...
const config = {
  projectName: 'taro-platform-mini',
  date: '2023-2-14',
  designWidth(input) {
  ...
  plugins: ['@tarojs/plugin-html', 'taro-plugin-pinia', ...routerPlugin],
  defineConstants: {},
  copy: {
    patterns: [],
    options: {},
